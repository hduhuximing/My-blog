...
![image-20200924231736945](必须了解的MySQL三大日志/image-20200924231736945.png)

`mysql` 支持三种将 `redo log buffer` 写入 `redo log file` 的时机，可以通过 `innodb_flush_log_at_trx_commit` 参数配置，各参数值含义如下：

![image-20200924231753251](必须了解的MySQL三大日志/image-20200924231753251.png)

![image-20200924231806319](必须了解的MySQL三大日志/image-20200924231806319.png)
...
![image-20200924231819088](必须了解的MySQL三大日志/image-20200924231819088.png)
...
![image-20200924231829731](必须了解的MySQL三大日志/image-20200924231829731.png)
