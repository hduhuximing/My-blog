...
![image-20200924210841990](MySQL优化原理简单讲解/image-20200924210841990.png)
...
![image-20200924210921025](MySQL优化原理简单讲解/image-20200924210921025.png)
...
![image-20200924211102022](MySQL优化原理简单讲解/image-20200924211102022.png)
...
![image-20200924211111998](MySQL优化原理简单讲解/image-20200924211111998.png)
...
![image-20200924211133786](MySQL优化原理简单讲解/image-20200924211133786.png)
...
![image-20200924211158146](MySQL优化原理简单讲解/image-20200924211158146.png)

接着插入下一个节点70，在Index Page中查询后得知应该插入到50 - 70之间的叶子节点，但叶子节点已满，这时候就需要进行也分裂的操作，当前的叶子节点起点为50，所以根据中间值来拆分叶子节点，如下图所示。

![image-20200924211212950](MySQL优化原理简单讲解/image-20200924211212950.png)

最后插入一个节点95，这时候Index Page和Leaf Page都满了，就需要做两次拆分，如下图所示。

![image-20200924211232082](MySQL优化原理简单讲解/image-20200924211232082.png)

拆分后最终形成了这样一颗树。



![image-20200924211243560](MySQL优化原理简单讲解/image-20200924211243560.png)
...
![image-20200924211254080](MySQL优化原理简单讲解/image-20200924211254080.png)
...
![image-20200924211320881](MySQL优化原理简单讲解/image-20200924211320881.png)
