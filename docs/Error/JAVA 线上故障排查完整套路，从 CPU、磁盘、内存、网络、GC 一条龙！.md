...
![image-20200923220133594](picture/image-20200923220133594.png)

接着直接在jstack中找到相应的堆栈信息`jstack pid |grep 'nid' -C5 –color`

![image-20200923220147457](picture/image-20200923220147457.png)
...
![image-20200923220202052](picture/image-20200923220202052.png)
...
![image-20200923220221432](picture/image-20200923220221432.png)

### 上下文切换

针对频繁上下文问题，我们可以使用vmstat命令来进行查看

![image-20200923220349042](picture/image-20200923220349042.png)

cs(context switch)一列则代表了上下文切换的次数。

如果我们希望对特定的pid进行监控那么可以使用 pidstat -w pid命令，cswch和nvcswch表示自愿及非自愿切换。

![image-20200923220358619](picture/image-20200923220358619.png)
...
![image-20200923220422611](picture/image-20200923220422611.png)



更多时候，磁盘问题还是性能上的问题。我们可以通过iostatiostat -d -k -x来进行分析

![image-20200923220434990](picture/image-20200923220434990.png)
...
![image-20200923220445742](picture/image-20200923220445742.png)



不过这边拿到的是tid，我们要转换成pid，可以通过readlink来找到pidreadlink -f /proc/*/task/tid/../..。

![image-20200923220500441](picture/image-20200923220500441.png)

找到pid之后就可以看这个进程具体的读写情况cat /proc/pid/io

![image-20200923220509665](picture/image-20200923220509665.png)



我们还可以通过lsof命令来确定具体的文件读写情况lsof -p pid

![image-20200923220517593](picture/image-20200923220517593.png)
...
![image-20200923220547677](picture/image-20200923220547677.png)
...
![image-20200923220604909](picture/image-20200923220604909.png)
...
![image-20200923220716151](picture/image-20200923220716151.png)
...
![image-20200923220728088](picture/image-20200923220728088.png)
...
![image-20200923220738925](picture/image-20200923220738925.png)



或者直接通过查看/proc/pid/task的数量即为线程数量。

![image-20200923220753430](picture/image-20200923220753430.png)
...
![image-20200923220808204](picture/image-20200923220808204.png)



我们如果确定有可疑的内存端，需要通过gdb来分析gdb --batch --pid {pid} -ex "dump memory filename.dump {内存起始地址} {内存起始地址+内存块大小}"

![image-20200923220820854](picture/image-20200923220820854.png)
...
![image-20200923220835456](picture/image-20200923220835456.png)



然后等放一段时间后再去看看内存增长的情况，通过jcmd pid VM.native_memory detail.diff(summary.diff)做一下summary或者detail级别的diff。

![image-20200923220849073](picture/image-20200923220849073.png)

![image-20200923220905883](picture/image-20200923220905883.png)
...
![image-20200923220918257](picture/image-20200923220918257.png)

此外在系统层面，我们还可以使用strace命令来监控内存分配 strace -f -e "brk,mmap,munmap" -p pid

这边内存分配信息主要包括了pid和内存地址。

![image-20200923220929602](picture/image-20200923220929602.png)
...
![image-20200923220952874](picture/image-20200923220952874.png)
...
![image-20200923221040232](picture/image-20200923221040232.png)
...
![image-20200923221052315](picture/image-20200923221052315.png)

如上图所示，overflowed表示全连接队列溢出的次数，sockets dropped表示半连接队列溢出的次数。

#### ss命令，执行ss -lnt

![image-20200923221104770](picture/image-20200923221104770.png)
...
![image-20200923221134347](picture/image-20200923221134347.png)

接下来我们通过wireshark打开抓到的包，可能就能看到如下图所示，红色的就表示RST包了。

![image-20200923221146904](picture/image-20200923221146904.png)
...
### ![image-20200923221200366](picture/image-20200923221200366.png)
